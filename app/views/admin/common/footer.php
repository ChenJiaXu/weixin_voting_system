...
<!-- AdminLTE App -->
<script src="<?php echo $base_url;?>/static/adminlte/js/app.min.js"></script>
<!-- Sparkline -->
...
<script src="<?php echo $base_url;?>/static/adminlte/js/demo.js"></script>
<!-- DataTables -->
<script src="<?php echo $base_url;?>/static/plugins/datatables/jquery.dataTables.min.js"></script>
<script src="<?php echo $base_url;?>/static/plugins/datatables/dataTables.bootstrap.min.js"></script>
<!-- bootstrap datepicker -->
<script src="<?php echo $base_url;?>/static/plugins/bootstrap-datetimepicker/js/bootstrap-datetimepicker.min.js"></script>
<script src="<?php echo $base_url;?>/static/plugins/bootstrap-datetimepicker/js/locales/bootstrap-datetimepicker.zh-CN.js"></script>
<!-- Select2 -->
