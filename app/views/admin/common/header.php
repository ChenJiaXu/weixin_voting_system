...
<head>
  ...
  <!-- Font Awesome -->
  <link rel="stylesheet" href="<?php echo $base_url;?>/static/font-awesome-4.5.0/css/font-awesome.min.css">
  <!-- Ionicons -->
  <link rel="stylesheet" href="<?php echo $base_url;?>/static/ionicons-2.0.1/css/ionicons.min.css">
  <!-- jvectormap -->
  ...
  <link rel="stylesheet" href="<?php echo $base_url;?>/static/plugins/bootstrap-datetimepicker/css/bootstrap-datetimepicker.min.css">
  <!-- Select2 -->
  ...
  <!-- Theme style -->
  <link rel="stylesheet" href="<?php echo $base_url;?>/static/adminlte/css/AdminLTE.min.css">
  <!-- AdminLTE Skins. Choose a skin from the css/skins folder instead of downloading all of them to reduce the load. -->
  <link rel="stylesheet" href="<?php echo $base_url;?>/static/adminlte/css/skins/_all-skins.min.css">
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
              ...
              <li>
                ...
                <ul class="menu">
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        <img src="<?php echo $base_url;?>/static/adminlte/img/user3-128x128.jpg" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        <img src="<?php echo $base_url;?>/static/adminlte/img/user4-128x128.jpg" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        Developers
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?php echo $base_url;?>/static/adminlte/img/user2-160x160.jpg" class="user-image" alt="User Image">
