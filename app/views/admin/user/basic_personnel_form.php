                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-10 <?php if(form_error('description')){echo 'has-error';}?>">
                                        <script id="description" name="description" type="text/plain">
                                            <?php echo $bp_action == 'add'?set_value(html_escape('description')):htmlspecialchars_decode(html_entity_decode($bps['description'])); ?>
                                        </script>
    ...
    <script type="text/javascript">
        var ue = UE.getEditor('description',{
            toolbars: [
                ['fullscreen', 'source', 'undo', 'redo', 'bold', 'indent', 'italic', 'underline', 'strikethrough', 'fontfamily','fontsize', 'justifyleft', 'justifyright', 'justifycenter', 'justifyjustify', 'forecolor', 'backcolor', 'removeformat',]
            ]
        });
        ue.ready(function() {
            ue.setHeight(200);
