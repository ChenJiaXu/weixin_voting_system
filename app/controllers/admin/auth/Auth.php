...
class Auth extends CI_Controller {
	...
	function __construct()
	{
		...
		$this->lang->load('admin/auth/auth');
		$this->lang->load('admin/auth/ion_auth');
		$this->load->helper('language');

		$this->load->model('admin/menu/Menu_model');
		$this->data['base_url'] = $this->config->item('base_url');
		$this->data['lefts'] = $this->Menu_model->getMenu();
	}
	...
	function login()
	{
		...
		else
		{
			...
			$this->_render_page('admin/common/login_header',$this->data);
			$this->_render_page('admin/auth/login', $this->data);
			$this->_render_page('admin/common/login_footer',$this->data);
		}
	}
